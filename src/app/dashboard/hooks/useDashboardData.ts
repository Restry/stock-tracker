...
export interface DashboardData {
  ...
  activeTab: "decisions" | "history" | "logs" | "backtest" | "optimize";
  setActiveTab: (tab: "decisions" | "history" | "logs" | "backtest" | "optimize") => void;
...
export function useDashboardData(): DashboardData {
  ...
  const [activeTab, setActiveTab] = useState<"decisions" | "history" | "logs" | "backtest" | "optimize">("decisions");
