...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Settings Modal */}
      {showSettings && <SettingsModal onClose={() => setShowSettings(false)} onResetComplete={fetchData} />}
    </div>
  );
}
...
function SettingsModal({ onClose, onResetComplete }: { onClose: () => void; onResetComplete: () => Promise<void> }) {
